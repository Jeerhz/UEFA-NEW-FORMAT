...
"Uncomment this part and comment the pots of the champions league if you want to select Europa League teams"
# Europa League Teams
# const potA = (
...
function solve_problem(selected_team::Team, constraints::Dict{String,Constraint}, new_match::NTuple{2,Team})::Bool
    model = Model(Gurobi.Optimizer; add_bridges=true)
